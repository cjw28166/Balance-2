...
void TimerTaskLoop100Hz(void)
{
	...
	//if(Aimbot.PitchRelativeAngle!=0)
		...
		printf("%f,%f,%f,%f\n",Gimbal.Pid.Rotor.s_set,Gimbal.Pid.Rotor.s_fdb,Gimbal.Pid.Rotor.v_set,Gimbal.Pid.Rotor.v_fdb);
		//printf("%f,%f\n",-Gimbal.Pid.AmmoLeft.fdb,Gimbal.Pid.AmmoRight.fdb);
		//printf("%f,%f,%f\n",Gimbal.Command.Pitch,Gimbal.Pid.Pitch.s_fdb,Gimbal.Pid.Pitch.s_set);
}
